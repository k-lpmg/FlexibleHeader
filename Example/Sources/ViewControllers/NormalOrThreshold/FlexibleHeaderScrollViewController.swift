//
//  FlexibleHeaderScrollViewController.swift
...
final class FlexibleHeaderScrollViewController: UIViewController {
    ...
    init(headerExecutantType: FlexibleHeaderExecutantType) {
        flexibleHeaderScrollView = {
            let flexibleHeaderScrollView = FlexibleHeaderScrollView(headerMaxHeight: 64, headerMinHeight: 0, headerExecutantType: headerExecutantType)
...
extension FlexibleHeaderScrollViewController {
